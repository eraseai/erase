...
def train(args,model,A,L_all,Y_all, data,optimizer,epoch):
    ...
    loss_func = MaximalCodingRateReduction(gam1=args.gam1, gam2=args.gam2, eps=args.eps,corafull=True)
    loss,loss_empi,L_all = loss_func(out,data,A,Y_all,args.alpha,args.beta,args.T,data.train_mask)
...
def main():
    ...
    parser.add_argument("--dataset", dest="dataset", default='CoraFull',type=str)
    #ERASE settings
    ...
    args.exp_dir = os.path.join(args.exp_dir,args.dataset,f'noise_ratio_{args.corrupt_ratio:.1f}')
